						...
						<div class="row">
							...
							<div class="col-xs-6">
								<button type="button" class="btn btn-primary btn-sm btn-block">
									<span class="glyphicon glyphicon-share-alt"></span> <a href="/" style="text-decoration: none; color: white">Continue shopping</a> 
								</button>
							</div>
						</div>
					</div>
					...
					<div class="row text-center">
						...
						<div class="col-xs-3">
							<button type="button" class="btn btn-success btn-block">
                                <a href="../basket/checkout" style="text-decoration: none; color: green">
								Checkout</a>
							</button>
						</div>
					</div>
